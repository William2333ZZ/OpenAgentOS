...
static char g_result[48];

void worker_main(void) {
    int sum;
    int pos = 0;
    const char *prefix = "ver=2 sum=";

    log_str("[worker-v2] loaded agent running\n");
    sum = tool_add(20, 64);
    log_str("[worker-v2] sum=");
    log_int(sum);
    log_str("\n");
