...
extern void init_v02_rc_agent(void);

void kmain(void) {
    smp_boot(0, 0);

    agentos_boot_banner("v0.2-rc — dual-platform v7 + policy load");
    agentos_trap_init();
    mem_init();
    vm_init();
    ramfs_init();
