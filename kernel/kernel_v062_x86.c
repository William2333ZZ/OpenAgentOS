...
extern void init_v062_agent(void);

void kmain(void) {
    smp_boot(0, 0);

    agentos_boot_banner("0.6.2 — agent sandbox-net (x86 parity)");
    agentos_trap_init();
    mem_init();
    vm_init();
    ramfs_init();
