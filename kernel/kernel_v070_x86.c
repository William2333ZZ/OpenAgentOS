...
extern void init_v070_agent(void);

void kmain(void) {
    smp_boot(0, 0);

    agentos_boot_banner("0.7.0 — agent sandbox-net (x86 parity)");
    agentos_trap_init();
    mem_init();
    vm_init();
    ramfs_init();
