...
extern void init_v01_beta_agent(void);

void kmain(void) {
    smp_boot(0, 0);

    agentos_boot_banner("v0.1-beta GA — Field Pilot sub-OS");
    agentos_trap_init();
    mem_init();
    vm_init();
    ramfs_init();
