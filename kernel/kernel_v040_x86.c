...
extern void init_v040_agent(void);

void kmain(void) {
    smp_boot(0, 0);

    agentos_boot_banner("0.4.0 — virtio-net fleet + remote tcp");
    agentos_trap_init();
    mem_init();
    vm_init();
    ramfs_init();
